...
function displayCourses(filteredCourses) {
    ...
    const certificateSection = document.querySelector('.card:nth-of-type(3)');
    ...
    const container = certificateSection.querySelector('.courses-container');
    const creditsDiv = certificateSection.querySelector('.total-credits');
    ...
    creditsDiv.innerHTML = `<strong>Total Credits Displayed: ${totalCredits}</strong>`;
